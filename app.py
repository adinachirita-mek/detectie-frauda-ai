...
with tab3:
    ...
    if fisiere_ok:
        ...
        PROFILE = {
            "Cumparaturi online (149 EUR, comportament normal)": {
            ...
            "Plata utilitate (2.69 EUR, tranzactie mica)": {
                "amount": 2.69, "time": 0.0,
                "V": [1.1919, 0.2662, 0.1665, 0.4482, 0.06, -0.0824, -0.0788, 0.0851,
                      -0.2554, -0.167, 1.6127, 1.0652, 0.4891, -0.1438, 0.6356, 0.4639,
                      -0.1148, -0.1834, -0.1458, -0.0691, -0.2258, -0.6387, 0.1013, -0.3398,
                      0.1672, 0.1259, -0.009, 0.0147],
            },
            "Achizitie electronice (378 EUR, suma mare)": {
                "amount": 378.66, "time": 1.0,
                "V": [-1.3584, -1.3402, 1.7732, 0.3798, -0.5032, 1.8005, 0.7915, 0.2477,
                      -1.5147, 0.2076, 0.6245, 0.0661, 0.7173, -0.1659, 2.3459, -2.8901,
                      1.11, -0.1214, -2.2619, 0.525, 0.248, 0.7717, 0.9094, -0.6893,
                      -0.3276, -0.1391, -0.0554, -0.0598],
            },
            ...
            "--- FRAUDA --- Suma 239 EUR, tranzactie suspecta": {
